...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    JTextField tfname,tffname,tfaddress,tfphone,tfx,tfxii,tfemail,tfaadhar;
    JLabel labelempid;
    JDateChooser dcdob;
   ...
   lbldob.setBounds(400,200,200,30);
    ...
    JLabel lblbranch = new JLabel("Department Name");
    lblbranch.setBounds(400,400,200,30);
    lblbranch.setFont(new Font("serif", Font.BOLD,20));
    add(lblbranch);
    
    
    String branch[] ={"Computer Science","Arts","Information Technology","Chemistry","Physics","Biology","Math","Accounting","Economics","History"};
